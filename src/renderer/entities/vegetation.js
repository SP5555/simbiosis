...
export default class Vegetation {
    constructor(cell, position) {
        ...
        this.vegMatrix = new THREE.Matrix4();
        const translateMatrix = new THREE.Matrix4().makeTranslation(
            this.position.x,
            this.position.y,
            this.position.z,
        );
        this.vegMatrix.multiply(translateMatrix).multiply(this.rotationMatrix);
    }
    ...
    update(dt) {
        ...
        const s = 0.2 + 0.8 * veg;
        const vegMatrix = new THREE.Matrix4();
        ...
        vegMatrix.multiply(translateMatrix).multiply(this.rotationMatrix).multiply(scaleMatrix);
        this.vegMatrix = vegMatrix;
